            ...
            <div className="bg-base-200">
                <footer className="container mx-auto footer p-10  text-base-content">
                    <nav className='grid grid-cols-1'>
                        <img src={logo} alt="" />
                        <p>Vivamus porta efficitur <br /> nibh nec convallis.bronvallis. <br /> Vestibulum egestas eleifend justo. <br /> Ut tellus ipsum, accumsan</p>
                    </nav>
                    <nav>
                        <div className=''>
                            <div >
                ...
                <footer className="container mx-auto footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                    <aside className="items-center grid-flow-col">
                        <p>© Copyrights 2023 JuBu Bhai All rights reserved</p>
                    </aside>
